...
$comptrnr="select * from companies where companyid='".$s1f['companyid']."';";
$compq=mysql_query($comptrnr)or exit(mysql_error());
$compf=mysql_fetch_assoc($compq);
$companytrn=$compf['trn'];
///////////mpdf
...
$inv="select * from invoice where card_id='".$_GET['cardid']."';";
$invr=mysql_query($inv);
$invf=mysql_fetch_assoc($invr);
$invnum=$invf['invoicenumber'];
////////////////////////////////////////////////////////////////////
...
<div style="width:100%;height:12px;float:right;text-align:right;"><h4>Invoice Number #: '.$invnum.'</h4></div>
<div style="width:100%;height:12px;float:right;text-align:right;font-size:12px;margin-top:-20px;"><h4>TRN#:100332687100003</h4></div>
<div style="width:100%;height:12px;float:right;text-align:right;"><h4>Invoice Date: '.datareformat($invf['invoice_date']).'</h4></div>
...
<tr><td style="width:150px;vertical-align:top;"><strong>TRN#:  </strong></td><td style="width:150px;">'.$companytrn.'</td></tr><tr>
...
$tot="select sum(linetotal) as total from services where cardid='".$_GET['cardid']."';";
